...
.. module:: suntime
   ...
   ***********************
   ...
   Calculate the sunrise time for the given date. It returns a tuple
   of integers `(hour, minute)` in UTC time or `None` if sun doesn't
   raise on that location at the given date.

   .. method:: get_sunset_time(year, month, day)

   Calculate the sunset time for the given date. It returns a tuple
   of integers `(hour, minute)` in UTC time or `None` if sun doesn't
